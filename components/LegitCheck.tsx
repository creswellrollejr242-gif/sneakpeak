  ...
  return (
    <div className="h-full overflow-y-auto p-4 pb-24">
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 mb-6">
        <h2 className="text-2xl font-black italic text-white mb-2 tracking-tighter">KICKFLIP <span className="text-violet-500">VISION</span></h2>
        <p className="text-zinc-400 text-sm mb-6">
          Upload a clear photo of the sneaker (side profile, tag, or stitching) for AI authentication.
        </p>
        ...
        {!image ? (
          ...
          >
            ...
            <span className="text-zinc-300 font-medium">Tap to Upload Photo</span>
          ...
          <div className="relative rounded-xl overflow-hidden h-64 border border-zinc-700">
            ...
            {analyzing && (
              <div className="absolute inset-0 bg-black/60 backdrop-blur-sm flex flex-col items-center justify-center">
                 ...
                 <span className="text-violet-400 font-mono animate-pulse">ANALYZING...</span>
              </div>
            )}
            {!analyzing && !result && (
               <button 
        ...
        <div className={`rounded-xl p-6 border-l-4 ${
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">Confidence: <span className="text-white font-mono">{result.confidence}%</span></p>
            </div>
          </div>
          
          <div className="bg-black/30 rounded-lg p-4 mb-4">
             <h4 className="text-xs font-bold text-zinc-500 uppercase mb-1">AI Reasoning</h4>
