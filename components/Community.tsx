...
import { Heart, MessageCircle, Share2, Award, X, Send, Image as ImageIcon, Plus, Trophy, TrendingUp } from 'lucide-react';
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                 <div className="pb-4 border-b border-zinc-800/50 mb-4">
                    <div className="flex items-center gap-2 mb-2">
                       <img src={activePost.userAvatar} className="w-6 h-6 rounded-full" />
                 ...
                 {activePost.comments.length === 0 ? (
                   ...
                   activePost.comments.map(comment => (
                     <div key={comment.id} className="flex gap-3">
                        <img src={comment.avatar} className="w-8 h-8 rounded-full bg-zinc-800" />
