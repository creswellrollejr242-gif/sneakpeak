...
import { Home, Calendar, Flame, Users, ScanLine, MessageCircle, ArrowRightLeft, Sparkles, Settings, Bell, Search } from 'lucide-react';
      ...
      case 'home':
        return (
          <div className="h-full overflow-y-auto pb-40 bg-zinc-950 font-sans no-scrollbar">
            {/* News Ticker */}
            <div className="bg-violet-600/10 border-b border-violet-500/20 py-2 overflow-hidden flex items-center mb-8">
            ...
            {/* PRIMARY FOCUS: Market Stories restored to top */}
            <div className="mb-10">
