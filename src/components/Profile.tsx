...
import { Settings, Edit2, X, ChevronRight, BookOpen, ListChecks, LogOut, Info } from 'lucide-react';
        ...
        <div className="mb-10 space-y-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-sm text-zinc-300 font-bold uppercase">App Features</p>
            </div>
