    ...
    return (
      <div className="h-full flex flex-col bg-zinc-950 pb-20">
        ...
        <div className="p-4 border-b border-zinc-800 flex items-center gap-3 bg-zinc-900/50 backdrop-blur-md">
          ...
          <img src={activeChat.userAvatar} className="w-10 h-10 rounded-full border border-zinc-700" alt="avatar" />
          <div>
              ...
              return (
                <div key={msg.id} className={`flex ${msg.sender === 'me' ? 'justify-end' : 'justify-start'}`}>
                  <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden w-64 shadow-lg">
                    ...
                    {sneaker && (
                      <div className="p-3">
                        <img src={sneaker.image} className="w-full h-32 object-cover rounded-lg mb-2" alt={sneaker.name} />
        ...
        {conversations.map(chat => (
          ...
          >
            <div className="relative">
              <img src={chat.userAvatar} className="w-14 h-14 rounded-full object-cover" alt={chat.withUser} />
              {chat.unread > 0 && (
